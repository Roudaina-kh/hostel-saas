...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .d4{animation-delay:320ms} .d5{animation-delay:420ms}
...
<body>
    ...
    <a href="{{ url('/') }}"
       style="position:fixed;top:20px;left:24px;z-index:999;display:flex;align-items:center;gap:8px;
              background:rgba(255,255,255,0.1);border:1px solid rgba(255,255,255,0.2);border-radius:24px;
              padding:8px 16px 8px 10px;text-decoration:none;font-size:0.82rem;font-weight:600;
              color:rgba(255,255,255,0.7);backdrop-filter:blur(8px);transition:all 0.2s"
        ...
        <div class="card">
            ...
            <div class="fade-up d1" style="text-align:center;">
                <div class="logo-ring">
                    ...
                    <span style="display:none; font-size:20px; font-weight:900; color:#fff;">HF</span>
                </div>
            </div>
            ...
            <div class="fade-up d5" style="text-align:center; margin-top:24px;">
            ...
            <p class="footer-text">HostelFlow © {{ date('Y') }} — Accès réservé aux administrateurs</p>
        </div>
    </div>
