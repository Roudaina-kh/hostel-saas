...
<head>
    ...
    <style>
        ...
        .btn-blue {
            ...
            padding: 0.875rem 1.75rem; border-radius: 16px;
            box-shadow: 0 8px 20px rgba(37,99,235,0.25);
            transition: all 0.3s cubic-bezier(0.25,1,0.5,1);
        }
        .btn-blue:hover { transform: translateY(-3px); box-shadow: 0 12px 28px rgba(37,99,235,0.35); }
        .btn-blue svg { transition: transform 0.3s ease; }
        .btn-blue:hover svg { transform: rotate(90deg) scale(1.1); }
        .glass-table {
            background: #FFFFFF; border: 1px solid #E8EEF2;
            border-radius: 24px; box-shadow: 0 12px 30px rgba(0,0,0,0.03); overflow: hidden;
        }
        .table-header-blue {
...
<body class="antialiased h-screen flex overflow-hidden selection:bg-[#3B82F6] selection:text-white"
      style="background-color:#F8FAFC; color:#1E293B; font-family:'Inter',sans-serif;">

    @include('layouts.sidebar')

    {{-- Contenu principal — overflow-y-auto pour scroller --}}
    <div class="flex-1 flex flex-col overflow-y-auto relative" style="height:100vh;">
