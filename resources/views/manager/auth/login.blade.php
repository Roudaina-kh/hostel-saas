...
<body style="min-height:100vh; display:flex; align-items:center; justify-content:center;
             background: linear-gradient(135deg, #0F4C3A 0%, #1A6B4F 50%, #2A8A6A 100%);">
...
<div style="width:100%; max-width:420px; padding:1rem;">
    ...
    <div style="text-align:center; margin-bottom:2rem;">
        ...
        <h1 style="color:white; font-size:1.5rem; font-weight:700; margin:0;">Manager</h1>
        <p style="color:rgba(255,255,255,0.6); font-size:0.875rem; margin:0.5rem 0 0;">
            Accédez à la gestion de votre hostel
        </p>
    </div>

    <div style="background:rgba(255,255,255,0.07); border-radius:1.25rem; padding:2rem;
        ...
        <form method="POST" action="{{ route('user.login.store') }}">
            ...
            <div style="display:flex; align-items:center; gap:0.5rem; margin-bottom:1.5rem;">
                <input type="checkbox" name="remember" id="remember"
                       style="accent-color:#2A8A6A; width:16px; height:16px;">
            ...
            <button type="submit"
                    style="width:100%; padding:0.875rem; border-radius:0.75rem; border:none;
                           ...
                           background:linear-gradient(135deg, #1A6B4F, #2A8A6A);
                           box-shadow:0 4px 15px rgba(42,138,106,0.4);">
