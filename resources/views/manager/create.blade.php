...
<div class="max-w-6xl mx-auto px-4 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ $routes['index_url'] }}" class="text-sm text-blue-600 hover:underline">← Retour aux réservations</a>
    </div>
    ...
    <form method="POST" action="{{ $routes['store_url'] }}" id="reservation_form">
        @csrf
...
{{-- ✅ FIX CRITIQUE : routes dynamiques selon owner/manager/staff --}}
var ROUTES = {
    availableUnits: '{{ $routes["avail_url"] }}',
    checkPassword:  '{{ $routes["pwd_url"] }}',
    csrf:           '{{ csrf_token() }}'
};
