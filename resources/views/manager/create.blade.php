...
<div class="max-w-xl">
    <div class="mb-6">
        ...
        <p class="text-sm mt-1" style="color: #8A9BB0;">Créez un compte pour un membre de votre équipe.</p>
    </div>
    ...
    <div class="bg-white rounded-2xl p-8 shadow-sm" style="border: 1px solid #E8EEF2;">
        ...
        <form method="POST" action="{{ route('managers.store') }}" class="space-y-5">
            @csrf
            <div>
            ...
            <div>
                ...
                <select name="role" required
                    ...
                    <option value="staff" {{ old('role') === 'staff' ? 'selected' : '' }}>Staff Opérationnel</option>
                    <option value="financial" {{ old('role') === 'financial' ? 'selected' : '' }}>Responsable Financier</option>
                </select>
            </div>
